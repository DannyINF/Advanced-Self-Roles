...
public class ReactionListener extends ListenerAdapter {
    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        ...
        List<String> buttonIds = Arrays.asList("garrysmod", "pings", "interests", "gleitung", "gadmin", "gsmod", "gmod",
                "gsup", "gdev", "gteam", "gel", "pspieleabend", "poverwatch", "pcsgo", "plol", "pamongus", "prainbow",
                "ispoiler");
        ...
        List<String> roleIds = Arrays.asList(STATIC.CategoryGmod, STATIC.CategoryPings, STATIC.CategoryInterests,
                ...
                STATIC.GEL, STATIC.PSpieleabend, STATIC.POverwatch, STATIC.PCSGO, STATIC.PLeagueOfLegends,
                STATIC.PAmongUs, STATIC.PRainbow, STATIC.ISpoiler);
